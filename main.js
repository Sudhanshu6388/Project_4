...
document.querySelector('.fa-circle-plus').addEventListener('click', () => {
    ...
    <section>
        <div id="input-div">
      <form>
         <input type="text" placeholder="add more list" id="todo-input">
      </form>
        </div>
    </section>
    <footer>
...
// add pop - up
  ...
  // making para click container
    ...
    <header>
      <div id="top-div">
        ...
        <div id="awesome-btn">
          <p id="para">Add item</p>
          <i class="fa-solid fa-circle-plus" id="fa-dice"></i>
        </div>
 ...
 // back - btn
    ...
    // add task
    let addBtn = document.querySelectorAll('.fa-file');
   ...
   for(let k = 0; k<arr.length; k++) {
    addBtn[k].addEventListener('click', () => {
      ...
      document.querySelector('#add-btn').addEventListener('click', () => {
        ...
        addItemDiv[k].innerHTML += '<p class="lists"></p><button class="list-btn">completed</button><br />'
  ...
  // removing container task
    let deleteBtn = document.querySelectorAll('.fa-eraser');
